  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="Login">
        ...
        <Stack.Screen name="EquipmentDetails" component={EquipmentDetails}options={{title: "Equipamentos" }} />
        ...
        <Stack.Screen name="RecipeDetails" component={RecipeDetails} options={{title: "Receitas" }} />
        <Stack.Screen name="RecipeRegistration" component={RecipeRegistration} options={{title: "Cadastro de Receita" }} />
